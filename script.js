const CurrentTimerContainer = document.getElementById(
...
btnSet.addEventListener("click", () => {
  ...
  if (totalTimerValue > 0) {
    ...
    <button class="btn" onclick="deleteCard(this)">Stop Timer</button>
  `;
  ...
  const myInterval = setInterval(() => {
    if (totalTimerValue === 0) {
      ...
      timerContainer.innerHTML = `
                                  ...
                                  <button class="btn dark" onclick="deleteCard(this)">Stop</button>`;
